...
function CreateLockHomeProduct() {
  ...
  const [smartHomeDetail, setSmartHomeDetail] = useState([]);
    ...
    if (param.id) {
      ...
      products.forEach((product) => {
        ...
        smartHome.forEach((smartHome) => {
          if (smartHome.idProduct === param.id) setSmartHomeDetail(smartHome);
        });
      });
    } else {
      setOnEdit(false);
  ...
  const handleChangeInputDT = (e) => {
    const { name, value } = e.target;
    setSmartHomeDetail({ ...smartHomeDetail, [name]: value });
    // console.log(smartHomeDetail);
  };
    ...
    try {
      ...
      if (onEdit) {
        const res = await axios.put(
          `/api/products_smarthome/${product._id}`,
          { ...smartHomeDetail, ...product, images },
          {
            headers: { Authorization: token },
          }
        );
        ...
        <div className="create_product flex" key={product.id}>
          ...
          <form onSubmit={handleSubmit} className="flex-grow">
            ...
            <div className="w-full flex">
              <div className="w-1/3 px-4">
                <div className="row">
                  <p> Mở Khóa bằng ứng dụng</p>
                  <input
                    type="text"
                    name="appLock"
                    id="appLock"
                    required
                    value={smartHomeDetail.appLock}
                ...
                {/* <div className="row">
                  ...
                  <input
                    type="text"
                    name="supportalexagooglehomesiri"
                    id="supportalexagooglehomesiri"
                    required
                    value={smartHomeDetail.supportalexagooglehomesiri}
                    onChange={handleChangeInputDT}
                    className="p-2 border-2 my-2 w-full"
                  />
                </div> */}
                <div className="row">
                  ...
                  <select className="p-2 border-2 my-2 w-full" name='supportalexagooglehomesiri'
                    value={smartHomeDetail.supportalexagooglehomesiri} onChange={handleChangeInputDT}>
              ...
              <div className="w-1/3 px-4">
                {/* <div className="row">
                  ...
                  <input
                    ...
                    id="alarmViaApp"
                    required
                    value={smartHomeDetail.alarmViaApp}
                    onChange={handleChangeInputDT}
                    className="p-2 border-2 my-2 w-full"
                  />
                </div> */}
                <div className="row">
                  ...
                  <select className="p-2 border-2 my-2 w-full" name='alarmViaApp'
                    value={smartHomeDetail.alarmViaApp} onChange={handleChangeInputDT}>
                    <option value="" >------lựa chọn------</option>
                    <option value={true} >có</option>
                    <option value={false} key={false}>không</option>
                  </select>
                ...
                {/* <div className="row">
                  ...
                  <input
                    ...
                    id="usersharing"
                    required
                    value={smartHomeDetail.usersharing}
                    onChange={handleChangeInputDT}
                    className="p-2 border-2 my-2 w-full"
                  />
                </div> */}
                <div className="row">
                  ...
                  <select className="p-2 border-2 my-2 w-full" name='usersharing'
                    value={smartHomeDetail.usersharing} onChange={handleChangeInputDT}>
                    <option value="" >------lựa chọn------</option>
                    <option value={true} >có</option>
                    <option value={false} key={false}>không</option>
                  </select>
              ...
              <div className="w-1/3 px-4">
                <div className="row">
                  ...
                  <input
                    ...
                    id="electric"
                    required
                    value={smartHomeDetail.electric}
                    onChange={handleChangeInputDT}
                    className="p-2 border-2 my-2 w-full"
                  />
                </div>
                <div className="row">
                  ...
                  <input
                    ...
                    id="loadCurrent"
                    required
                    value={smartHomeDetail.loadCurrent}
                    onChange={handleChangeInputDT}
                    className="p-2 border-2 my-2 w-full"
                  />
                </div>
